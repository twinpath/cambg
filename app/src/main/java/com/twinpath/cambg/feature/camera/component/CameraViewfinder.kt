...
fun CameraViewfinder(
    ...
    val serviceState by com.twinpath.cambg.feature.camera.service.BackgroundRecordingService.serviceState.collectAsState()

    DisposableEffect(Unit) {
        onDispose {
            com.twinpath.cambg.feature.camera.service.BackgroundRecordingService.setPreviewView(null)
        }
    }
        ...
        if (hasCameraPermission) {
            ...
            LaunchedEffect(
                ...
                if (serviceState.isServiceRunning) {
                    com.twinpath.cambg.feature.camera.service.BackgroundRecordingService.setPreviewView(pv)
                } else {
            ...
            LaunchedEffect(uiState.zoomRatio, uiState.flashMode) {
                if (serviceState.isServiceRunning) {
                    com.twinpath.cambg.feature.camera.service.BackgroundRecordingService.updateCameraControls(
                        flashMode = uiState.flashMode,
                        zoomRatio = uiState.zoomRatio,
                        isFrontCamera = uiState.isFrontCamera
                    )
